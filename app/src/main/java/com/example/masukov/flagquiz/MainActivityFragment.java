...
public class MainActivityFragment extends Fragment {
    ...
    private static final String TAG = "Football Quiz Activity";

    private static final int EMBLEMS_IN_QUIZ = 10;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        emblemImageView = (ImageView) view.findViewById(R.id.emblemImageView);
        ...
        questionNumberTextView.setText(getString(R.string.question, 1, EMBLEMS_IN_QUIZ));
        return view;
    }
    ...
    public void resetQuiz() {
        ...
        while (flagCounter <= EMBLEMS_IN_QUIZ) {
    ...
    private void loadNextEmblem() {
        String nextImage = quizClubsList.remove(0);
        correctAnswer = nextImage;
        answerTextView.setText("");
        questionNumberTextView.setText(getString(R.string.question, (correctAnswers + 1), EMBLEMS_IN_QUIZ));
        String region = nextImage.substring(0, nextImage.indexOf('-'));
        AssetManager assets = getActivity().getAssets();

        try (InputStream stream = assets.open(region + "/" + nextImage + ".png")) {
            Drawable flag = Drawable.createFromStream(stream, nextImage);
            emblemImageView.setImageDrawable(flag);
            animate(false);
        }
        catch (IOException exception) {
        ...
        fileNameList.add(fileNameList.remove(correct));// ответ в конец
        ...
        // правильн ответ рандомно
        int row = random.nextInt(guessRows);
        int column = random.nextInt(2);
        LinearLayout randomRow = guessLinearLayouts[row];
        String countryName = getClubName(correctAnswer);
    ...
    private OnClickListener guessButtonListener = new OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            if (guess.equals(answer)) {
                ...
                if (correctAnswers == EMBLEMS_IN_QUIZ) {
            ...
            else { // не правильн ответ
                emblemImageView.startAnimation(shakeAnimation);
